...
decrypt_second_puzzle = DecipherSimple(
...
def DecipherSmallPrime(ciphertext, modulo, exponent):
    ...
    for small_prime in range(3, 1000000, 2):
...
decrypt_sixth_puzzle = DecipherCommonDivisor(
    first_ciphertext,
    first_modulo,
    first_exponent,
    second_ciphertext,
...
decrypt_seventh_puzzle = DecipherHastad(
    first_ciphertext, first_modulo, second_ciphertext, second_modulo
)
...
final_answer = (
    decrypt_sixth_puzzle[0] + decrypt_sixth_puzzle[1] + decrypt_seventh_puzzle
)
print(final_answer)
